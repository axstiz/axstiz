...
Спроектировал AI-ядро пайплайна потокового анализа логов. Система читает логи через Vector → Kafka → LangGraph DAG → Postgres. Совместил LLM-анализ с сигнатурными движками YARA/Sigma в одном графе.
